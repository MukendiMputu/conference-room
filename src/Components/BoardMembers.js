            ...
            <div className="container-width">
                ...
                <div className="badges">
                    <div className="badge">
                        ...
                        <div className="badge-foot"><span className="badge-link"><ImFacebook /></span><span className="badge-link"><ImTwitter /></span><span className="badge-link"><ImLinkedin /></span></div>
                    </div>
                    <div className="badge">
